...
kappa_mu = 0.1 #very low concentration across individual heading biases
kappa_id = 5.0 #high within-individual concentration

set.seed(591005598)#DOI Baird et al., 2010
dt2 = rvonmises(n = ndata,
                mu = c0,
                kappa = kappa_mu)
print(round(dt2))
...
#collect data
dt_var = data.frame(y = as.numeric( rad(unlist(dt_id_var)) ),#angles as a numeric vector in radians
                         ID = factor(x = #individual labels as an unordered categorical (factor)
                                       sort(
...
#collect data
dt_headchange = data.frame(y = as.numeric( rad(c(dt_comb_hd, dt_comb_delta)) ),#angles as a numeric vector in radians
