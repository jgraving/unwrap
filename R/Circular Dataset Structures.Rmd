...
This introduces the possibility of large variations in individual concentration ($\alpha_i$), including a $\approx 1\%$ chance of completely uniform heading distributions ($\kappa = 0$) for some individuals (assuming a rectified normal distribution).
...
```
Despite the modest inter-individual correlation, 4 individuals diverge from the population mean direction by $>90°$. Individual concentrations also vary from $\kappa = 1.14$ to  $\kappa = 2.65$, indeed in a larger population we would expect $95\%$ of individual $\alpha_i$ in (0.5, 2.5), corresponding to (circular) standard deviations between 96° and 42°.
